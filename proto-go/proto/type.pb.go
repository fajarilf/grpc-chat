...
func (x *Room) GetBackground() string {
	if x != nil {
		return x.Background
	}
	return ""
...
func (x *Room) GetBackgroundType() string {
	if x != nil {
...
const file_type_proto_rawDesc = "" +
	...
	"background\x12'\n" +
	"\x0fbackground_type\x18\x05 \x01(\tR\x0ebackgroundTypeB(Z&github.com/fajarilf/grpc-chat/proto-gob\x06proto3"
